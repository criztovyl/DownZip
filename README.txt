...
There is a secured and unsecured version. In the secured you need a Auth_Key to start the Download, the keys are defined in the file. (See Configuration).
